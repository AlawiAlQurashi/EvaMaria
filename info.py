...
BOT_TOKEN = environ.get('BOT_TOKEN', '5664558596:AAFUzIDdUQSbDruEqQzwQmBFqFd-G60slho')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6250435647').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bot_vambir:Al2552001@cluster0.heabj.mongodb.net/vambir_bot?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "vambir_bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anurag_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001852595452'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'P_R_C8')
